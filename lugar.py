...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.setStyleSheet("background-color: rgb(0, 0, 90);\n"
"color: rgb(255, 255, 255);")
        self.lblLugar = QtWidgets.QLabel(parent=Dialog)
        ...
        self.btnSiguiente = QtWidgets.QPushButton(parent=Dialog)
