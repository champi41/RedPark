...
"")
        ...
        self.retranslateUi(RedTicket)
        QtCore.QMetaObject.connectSlotsByName(RedTicket)

    def retranslateUi(self, RedTicket):
        _translate = QtCore.QCoreApplication.translate
        RedTicket.setWindowTitle(_translate("RedTicket", "Dialog"))
        self.lblRedTicket.setText(_translate("RedTicket", "<html><head/><body><p>Red<span style=\" color:#ff0004;\">Ticket</span></p></body></html>"))
        self.lblDuracionTicket.setText(_translate("RedTicket", "Duración:"))
        self.lblNombreTicket.setText(_translate("RedTicket", "Nombre:"))
        self.lblPatenteTicket.setText(_translate("RedTicket", "Patente:"))
        self.lblAviso2.setText(_translate("RedTicket", "Puede cerrar las ventanas"))
